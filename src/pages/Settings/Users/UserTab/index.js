  ...
  render() {
    ...
    return (
      <div className={classes.root}>
        <Grid md={12} item>
          {location.pathname !== '/settings/users/new-user' ? (
            <div>
                  ...
                  <TableBody>
                    {data.length > 0 &&
                      data
                        ...
                        .map((n) => {
                          const isSelected = this.isSelected(n.user_id);
                          return (
                            <TableRow
                              hover
                            ...
                            >
                              ...
                              <TableCell>{!n.node ? 'None' : n.node}</TableCell>
                              <TableCell>
                                {n.usergroup.role.role_name}
                              </TableCell>
                              <TableCell numeric>
                                <Chip
                                  label={n.active > 0 ? 'Active' : 'Not Active'}
            ...
            <UserTabForm
              dataRole={data.map((item) => item.usergroup.role.role_name)}
            />
          )}
        </Grid>
      </div>
